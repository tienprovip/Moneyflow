...
// ─── GET MARKET PRICES ───────────────────────────────────────────────────────
import { goldScraperService } from "./gold-scraper.service";

export const getMarketPrices = async (req: AuthRequest, res: Response) => {
  try {
    const prices = await goldScraperService.getMarketPrices();
